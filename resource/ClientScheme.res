...
{	
	...
	Colors
	{
        ...
        //// OPTIONAL ELEMENTS ////
         ...
         // Set the last value to "135" to enable or "0" to disable these specific feature
        "NameBG"        "0 0 0 135"       //TargetID background
        ...
        "Crosshair"             "255 255 255 155"     //Crosshair color
        "CrosshairDamage"       "255 0 0 150"         //Crosshair damage flash color
        ...
        "AmmoLow"              "225 75 75 255"      //Low ammo count
        
        "Health"               "227 227 227 255"      //Normal health color
        "Positive"             "0 185 255 255"      //Buffed HP    
        "Negative"            "255 35 35 255"       //Low HP    
        
        "ChargingUber"   "227 227 227 195"   //Percentage color when charging
        "Uber"           "65 220 65 195"     //Uber ready color
        "UberMeter"      "65 220 65 195"     //Uber meter color
		"UberFlash"      "220 50 220 195"    //Uber flash color
        
        "TournamentBuff"		"0 185 215 140"        //Tournament spectator Health Buff
		"TournamentBuff2"      "12 12 90 60"
		"TournamentHurt"        "215 30 40 120"       //Tournament spectator Health Hurt
		"TournamentHurt2"       "90 12 12 80"
		
        "Time"          "227 227 227 255"    //Timer color
		"Servertime"       "220 220 0 255"    //Server time left color
       
        //// STATS BAR COLORS
	   
        "StatBar1"						"200 125 255 148"
		"StatBar2"						"255 230 85 148"
		"StatBar3"						"255 85 111 148"
		"StatBar4"						"255 85 196 148"
		"StatBar5"						"105 200 255 148"
		"StatBar6"						"105 255 160 148"
		"StatBar7"						"255 160 105 148"
		"StatBar8"						"255 255 255 148"
		"StatBar9"						"130 125 125 148"
        ...
        "HudShadow"     "0 0 0 140"          //Shadow on numbers
