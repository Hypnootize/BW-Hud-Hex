...
bwHUD_hexEdition by daafunk.

/////////////////////////////////////////////

CREDITS:
Based in bwHUD (watterson) -- Hexagon/HUD elements (collycat) -- Control Points from ZimHUD (Zimmy) -- Winpanel from CBHUD (ColdBalls) -- 
MainMenu Inspired from AstroHUD (Quert) -- HUD elements from FlatHUD (Flatline).
